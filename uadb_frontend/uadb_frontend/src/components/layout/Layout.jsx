...
const NAV = {
  ...
  admin: [
    ...
    { label: 'Dossiers',            icon: FolderOpen,      to: '/admin/dossiers' },
    { label: 'Délibérations',       icon: BookOpen,        to: '/admin/deliberations' },
    { label: 'Attestations',        icon: FileCheck,       to: '/admin/attestations' },
