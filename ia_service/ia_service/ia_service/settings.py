...
DATABASES = {
    'default': {
        ...
        'NAME'    : config('DB_NAME',     default='uadb6_db'),
        'USER'    : config('DB_USER',     default='uadb6_user'),
        'PASSWORD': config('DB_PASSWORD', default='uadb6_pass'),
        'HOST'    : config('DB_HOST',     default='localhost'),
        'PORT'    : config('DB_PORT',     default='5432'),
        'OPTIONS' : {
            'options': '-c search_path=ia,public'
        },
    }
}
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'moteur.authentication.JWTFromAuthServiceAuthentication',
    ),
